...
public class Register extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        log.trace("User's email==>" + email + "name==>" + name + "surname==>" + surname + "password==>" + pass);
        ...
        UserDao userDao = new MySqlDaoFactory().getUserDao(MySQLConnectionUtils.getMySQLConnection());
